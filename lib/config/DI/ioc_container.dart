...
class IoCContainer {
  static Future<void> init(ProviderContainer providerContainer) async {
    ...
    final getPastOrdersUseCase = GetPastOrdersUseCase(orderRepository);
    getIt.registerSingleton<GetPastOrdersUseCase>(getPastOrdersUseCase);
    final getActiveOrderUseCase = GetActiveOrdersUseCase(orderRepository);
    getIt.registerSingleton<GetActiveOrdersUseCase>(getActiveOrderUseCase);
