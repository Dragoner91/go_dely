...
class DiscountRepositoryImpl extends IDiscountRepository {
  ...
  DiscountRepositoryImpl({required this.petition});


  @override
  Future<Result<List<Product>>> getDiscounts(GetProductsDto dto) async {
  ...
  @override
  Future<Result<Product>> getDiscountById(String id) async {
    final response = await petition.makeRequest(
      urlPath: '/discounts/$id',
      httpMethod: 'GET',
      mapperCallBack: (data) {
